...
public final class Operator {
  static final Controller m_controller = new Controller(OperatorConstants.kOperatorControllerPort);
  public static final CommandXboxController Command = m_controller.Command;
  ...
  public static Trigger LeftTrigger(double threshold) { return Command.leftTrigger(threshold); }
  public static Trigger LeftBumper() { return Command.leftBumper(); }
  
  public static Trigger RightTrigger(double threshold) { return Command.rightTrigger(threshold); }
  public static Trigger RightBumper() { return Command.rightBumper(); }
